...
class PatientHome(QMainWindow):
    def __init__(self):
        ...
        widget.setFixedSize(740,750)
        self.patientMainTable.setColumnWidth(0, 70)
        self.patientMainTable.setColumnWidth(1, 190)
        self.patientMainTable.setColumnWidth(2, 100)
        self.patientMainTable.setColumnWidth(3, 80)
        self.patientMainTable.setColumnWidth(4, 80)
        self.patientMainTable.setColumnWidth(5, 80)
...
class DoctorHome(QMainWindow):
    def __init__(self):
        ...
        widget.setFixedSize(740, 750)
        self.doctorMainTable.setColumnWidth(0, 70)
        self.doctorMainTable.setColumnWidth(1, 190)
        self.doctorMainTable.setColumnWidth(2, 100)
        self.doctorMainTable.setColumnWidth(3, 80)
        self.doctorMainTable.setColumnWidth(4, 80)
        self.doctorMainTable.setColumnWidth(5, 80)
...
class PharmacistHome(QMainWindow):
    def __init__(self):
        ...
        widget.setFixedSize(740, 750)
        self.pharmacistMainTable.setColumnWidth(0, 70)
        self.pharmacistMainTable.setColumnWidth(1, 190)
        self.pharmacistMainTable.setColumnWidth(2, 100)
        self.pharmacistMainTable.setColumnWidth(3, 80)
        self.pharmacistMainTable.setColumnWidth(4, 80)
        self.pharmacistMainTable.setColumnWidth(5, 80)
